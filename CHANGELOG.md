...
## [0.8.0](https://github.com/cot-rs/cot/compare/cot-v0.7.0...cot-v0.8.0) - 2026-09-23
...
- Migration dependency visualization using GraphViz/Mermaid ([#643](https://github.com/cot-rs/cot/pull/643)) (by [@ElijahAhianyo](https://github.com/ElijahAhianyo))
...
- *(ci)* Fix coverage failure ([#648](https://github.com/cot-rs/cot/pull/648)) (by [@m4tx](https://github.com/m4tx))
- *(db)* Classify foreign key violations ([#644](https://github.com/cot-rs/cot/pull/644)) (by [@oxura](https://github.com/oxura))
- Snapshot tests, update compiler output ([#635](https://github.com/cot-rs/cot/pull/635)) (by [@m4tx](https://github.com/m4tx))

### Other

- *(db)* Add info about populating `Auto` fields ([#675](https://github.com/cot-rs/cot/pull/675)) (by [@m4tx](https://github.com/m4tx))
- *(pre-commit.ci)* Pre-commit autoupdate ([#669](https://github.com/cot-rs/cot/pull/669)) (by [@pre-commit-ci[bot]](https://github.com/pre-commit-ci[bot]))
- Update Rust nightly, reformat ([#668](https://github.com/cot-rs/cot/pull/668)) (by [@m4tx](https://github.com/m4tx))
- Add Metadata schema and flag hook ([#663](https://github.com/cot-rs/cot/pull/663)) (by [@ElijahAhianyo](https://github.com/ElijahAhianyo))
...
- Add Migration docs ([#622](https://github.com/cot-rs/cot/pull/622)) (by [@ElijahAhianyo](https://github.com/ElijahAhianyo))
