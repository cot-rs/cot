...
use crate::{Result, impl_into_cot_error};

pub mod extractors;
mod path_params_deserializer;

/// HTTP request type.
pub type Request = http::Request<crate::Body>;
...
/// use cot_core::request::{PathParams, Request, RequestExt};
///
/// async fn my_handler(mut request: Request) -> cot_core::Result<Response> {
///     let path_params = request.path_params();
...
impl PathParams {
    ...
    ///
    /// ```
    /// use cot_core::request::PathParams;
    ///
