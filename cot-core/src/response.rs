...
//!
//! ```
//! use cot_core::response::ResponseExt;
//! ```
...
/// ```
///
/// [`IntoResponse`]: cot_core::response::IntoResponse
...
pub trait ResponseExt: Sized + private::Sealed {
    ...
    /// # See also
    ///
    /// * [`cot::reverse_redirect!`] – a more ergonomic way to create redirects
    ///   to internal views
    #[must_use]
